...
# ABSTRACT: Manage database handles safely.
...
Database::ManagedHandle - Database handles for long running processes.
...
a class. By default, the class name is Database::ManagedHandleConfig.
